...
namespace LoginEx
{
    public partial class Frm_MD : Form
    {
        ...
        private void fillToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.t_zg1TableAdapter.Fill(this.zgzyDataSet.t_zg1, bhToolStripTextBox.Text);
            }
        ...
        private void t_zyDataGridView_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                this.t_zg1TableAdapter.Fill(this.zgzyDataSet.t_zg1, t_zyDataGridView.CurrentRow.Cells[0].Value.ToString());
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
